...
const simpleGridExtensiveTests: ElementIdTest[] = [
  ...
  { desc: 'absolute farthest element n(orth) of DJ is A (simplegrid-extensive)', startingElementId: 'DJ', bearing: 'n', hasToAlign: HasToAlign.YES, expectedId: 'A', scroll: true },
